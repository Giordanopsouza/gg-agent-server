...
|---|---|---|---|
| 1a | `scaffold`, `loop` | [001](done/001-repo-scaffolding.md) … [007](007-in-process-demo.md) | `NOTES.md` from a Python module, no server |
...
```
tasks/
├── 004-local-workspace.md         # status: pending
├── done/
